...
```text
[0.0, 0.04879016416943204, 0.09531017980432493, 0.13976194237515863, 0.1823215567939546]
```



在上述示例中，我们使用了 `map` 方法将原始向量中的每个元素都除以 100 再取 ln，然后使用 `collect` 方法将结果收集到一个新的向量中。
