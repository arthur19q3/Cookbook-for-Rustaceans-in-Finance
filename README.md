...
荣幸向社区介绍一点微小的工作。这本书是我经过两年的耕耘，整理了开发 Rust 全栈量化金融软件和策略的实践经验，旨在为那些希望进入或已经涉足量化金融领域的 Rust 程序员提供宝贵的参考和洞见。

这本书的初衷是为了向读者提供核心原理和主要步骤的指导，而不是枯燥的详细说明。在已经公开的前 28 章中，你将会找到大量来自实际生产环境的示例代码，这些代码大都是极简的MWE(minimal working examples)，真实地反映了金融领域中的挑战和 Rust 语言的强大特性。
