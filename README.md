...
这本书的初衷是为了向读者提供核心原理和主要步骤的指导，而不是枯燥的详细说明。在已经公开的前 17 章中，你将会找到大量来自实际生产环境的示例代码，这些代码都是极简的工作示例，真实地反映了金融领域中的挑战和 Rust 语言的强大特性。希望些示例也会激发你的灵感，让你更加熟练地运用 Rust 来解决金融领域的问题。
